                        ...
                        <div className='mb-2'>
                            <div className='ml-2 flex'>
                                <span className='ml-2 flex'>
                                    ...
                                    <span className='font-iransans font-bold text-xs text-carbon-main inline-block '>جدید</span>
                                </span>
                                <p className='font-iransans text-xs text-inactive-dark inline-block'>(۴ )</p>
                            </div>
                        </div>
