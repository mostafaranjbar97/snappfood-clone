    ...
    <div ref={modalRef} className='left-[-1.875rem] absolute top-6 laptop:-left-[7.5rem] w-[16.25rem] min-h-12 text-carbon-main shadow-shadows-high rounded-lg flex flex-col justify-center overflow-hidden bg-white'>
        <Link href={"/"} className='w-full grow bg-transparent'>
            <div className='box-border w-full h-16 py-3 px-4 flex items-center '>
                <Image width={14} height={18} src={"/icons/header/user.svg"} className='ml-4'/>
        ...
        <button className='rtl min-h-12 justify-start flex pr-4 h-14 items-center cursor-pointer box-border min-w-[6.6875rem] rounded-md text-carbon-main w-full  transition-all'>
            <div className='w-full flex justify-between '>
                <div className='flex items-center'>
                    <Image width={20} height={20} src={"/icons/modal/snapp-club.svg"} className='ml-3.5'/>
                ...
                <div className='box-border mr-auto py-0.5 pr-1 pl-3 rounded-[2rem] flex items-center bg-golden-yellow-color border border-tangerine-yellow-color'>
                    <Image width={13} height={16} src={"/icons/modal/club-gem.svg"} className='mx-1'/>
        ...
        <button className='rtl min-h-12 justify-start flex pr-4 h-14 items-center cursor-pointer box-border min-w-[6.6875rem] rounded-md text-carbon-main w-full  transition-all'>
            <div className='w-full flex justify-between '>
                <div className='flex items-center'>
                    <Image width={17} height={16} src={"/icons/modal/wallet.svg"} className='ml-4'/>
        ...
        <button className='rtl min-h-12 justify-start flex pr-4 h-14 items-center cursor-pointer box-border min-w-[6.6875rem] rounded-md text-carbon-main w-full  transition-all '>
            <div className='flex items-center'>
                <Image width={18} height={17} src={"/icons/modal/referral-menu.svg"} className='ml-4'/>
                <p className='font-iransans text-sm text-carbon-main inline-block'>دعوت از دوستان</p>
            </div>
        </button>
        <button className='rtl min-h-12 justify-start flex pr-4 h-14 items-center cursor-pointer box-border min-w-[6.6875rem] rounded-md text-carbon-main w-full transition-all'>
            <div className='flex items-center'>
                <Image width={18} height={18} src={"/icons/modal/logout.svg"} className='ml-4'/>
