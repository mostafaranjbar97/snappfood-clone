        ...
        <div className='p-4 flex justify-between'>
            ...
            <div className='flex items-center'>
                ...
                <div className='relative bg-carbon-alphaLight rounded-xl cursor-pointer flex items-center'>
                    ...
                    <div onClick={sortHandler} id='1' className={clsx('z-[2] w-[7.3125rem] p-2.5 flex justify-center items-center border-2 border-carbon-alphaLight rounded-xl ',sort==1 ? 'text-accent2-main bg-white' : 'text-carbon-main bg-transparent')}>
                        <p className='font-iransans text-sm inline-block '>جدیدترین</p>
                    </div>
                    <div onClick={sortHandler} id='2' className={clsx('z-[2] w-[7.3125rem] p-2.5 flex justify-center items-center border-2 border-carbon-alphaLight rounded-xl ',sort==2 ? 'text-accent2-main bg-white' : 'text-carbon-main  bg-transparent')}>
